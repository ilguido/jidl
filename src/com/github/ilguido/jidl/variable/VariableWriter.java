...
/**
 * VariableWriter
 * Interface for writing to a variable on an industrial device.
 *
 * @version 0.8
 * @author Stefano Guidoni
 */

public interface VariableWriter extends Variable {
  /**
   * Writes the value of the variable to the remote device and returns a
   * handle to the written value.
   *
   * @param inClient a client as an object
   * @return a handle to the written value
   * @throws IOException in case of a connection error
   * @throws Exception in case of error when writing a variable
   */
  public Object write(Object inClient) throws IOException, Exception;
}
