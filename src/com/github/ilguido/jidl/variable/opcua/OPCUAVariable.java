...
/**
 * OPCUAVariable
 * Class for managing a variable from an industrial device through a OPC UA
 * connection.
 *
 * @version 0.8
...
public abstract class OPCUAVariable extends VariableCommon {
  /**
   ...
   *                                  is not a valid name
   */
  public OPCUAVariable(String inName, 
                       String inAddress,
                       DataType inType,
  ...
  /**
  * Checks that a given string is a valid OPC-UA address.  If address is not a
  ...
  * @throws IllegalArgumentException if address is not a valid OPC UA address
  */
  @Override
